//	Needed for 'products' collection.
import java.util.TreeMap;
//	Needed for 'coinBox' collection.
...
public class Shop {
	...
	*/
	public Shop(String name, int coins) {
		//	Name of shop instance.
		this.name = name;
		
		products = new TreeMap<String, Product>();
		
		//	Fill coinBox with number of coins supplied.
	...
	/**
	*	'addProduct' method. Takes a supplied product and adds it to the TreeMap 'products'.
	*/
	...
	/**
	*	'removeProduct' method. Takes a supplied product and removes it from the TreeMap 'products'.
	*/
	...
	*/
	...
	/**
	*	'addGoldCoin' method. Takes a supplied GoldCoin and adds it to this collection. 
	*/
	...
	/**
	*	'updateTotalSpend' method. Takes a supplied customer and amountOfCoins and updates a customer's 'customerTotalSpend'. 
	*/
	...
	*/
	public String toString() {
		//some way to also return the String info of every product in products.
